        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChildAge = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrialRequests_Centers_CenterId",
                        column: x => x.CenterId,
                        principalTable: "Centers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupChildren", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupChildren_Children_ChildId",
                        column: x => x.ChildId,
                        principalTable: "Children",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupChildren_Groups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupChildren_ChildId",
                table: "GroupChildren",
                column: "ChildId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupChildren_GroupId",
                table: "GroupChildren",
                column: "GroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrialRequests_CenterId",
                table: "TrialRequests",
                column: "CenterId");
